...
@onready var round_number_label = $HBoxContainer/RoundInfoContainer/MarginContainer/RoundInfo/Label
@onready var turns_remaining_label = $HBoxContainer/RoundInfoContainer/MarginContainer/RoundInfo/Turns
