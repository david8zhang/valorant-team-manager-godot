...
func update_preview(attacker: Agent, defender: Agent, weapon_to_attack_with: Weapon):
	...
	attacker_weapon.texture = weapon_to_attack_with.weapon_stats.in_game_texture
	if defender.primary_weapon:
		defender_weapon.texture = defender.primary_weapon.weapon_stats.in_game_texture
	else:
		defender_weapon.texture = defender.sidearm_weapon.weapon_stats.in_game_texture
